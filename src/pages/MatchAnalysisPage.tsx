...
import { X, Play, ChevronLeft, Loader2, AlertCircle, Camera, Clock, CheckCircle, Grid2x2 as Grid, List } from 'lucide-react';
    ...
    {playingPoint?.videoUrl && (
      <VideoPlayerModal
        ...
        metadata={{
          ...
          shotType: playingPoint.toggleValue || undefined,
